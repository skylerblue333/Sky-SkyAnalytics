...
**What this is:** **Sky-SkyAnalytics** is a public **platform and infrastructure** repository. Provides shared platform, infrastructure, architecture, deployment, or ecosystem-level work.

**Why it matters:** It helps related repositories share boundaries, conventions, infrastructure, and integration patterns. The repository’s current description is: “Repository for the SkyAnalytics component of the Sky ecosystem.”
